...
func DeleteClickDetailsHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		shortURL := mux.Vars(r)["shorturl"]
		if shortURL == "" {
...
func TotalCountNdaysHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		shorturl := mux.Vars(r)["shorturl"]
...
func TotalDetailsNdaysHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		shorturl := mux.Vars(r)["shorturl"]
		days := mux.Vars(r)["days"]
		if days == "" || shorturl == "" {
...
func TotalDetailsByCountryHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		shorturl := mux.Vars(r)["shorturl"]
...
func TotalDetailsByCityHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		shorturl := mux.Vars(r)["shorturl"]
...
func TotalDetailsByIP() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		shorturl := mux.Vars(r)["shorturl"]
		ip := mux.Vars(r)["ip"]
		if shorturl == "" || ip == "" {
...
func ClickCountsByIP() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		shorturl := mux.Vars(r)["shorturl"]
		ip := mux.Vars(r)["ip"]
		if shorturl == "" || ip == "" {
